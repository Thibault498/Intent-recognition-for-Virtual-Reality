...
from simu_kppv import simulation_kppv     
...
if __name__=="__main__":
    ...
    n23 = getelem('spe.csv',1,23)
    n24 = getelem('spe.csv',1,24)
    n25 = getelem('spe.csv',1,25)
        
    n27 = getelem('spe.csv',1,27)
    n28 = getelem('spe.csv',1,28)
    n29 = getelem('spe.csv',1,29)
        
    n31 = getelem('spe.csv',1,31)
    n32 = getelem('spe.csv',1,32)
    n33 = getelem('spe.csv',1,33)
    ...
    for i in range (3,1488):
        ...
        n1= getelem('spe.csv',i,1)
        n1= float(n1)
        time.append(n1)
        
        n3= getelem('spe.csv',i,3)
        n4= getelem('spe.csv',i,4)
        n5= getelem('spe.csv',i,5)
        n7= getelem('spe.csv',i,7)
        n8= getelem('spe.csv',i,8)
        n9= getelem('spe.csv',i,9)
        ...
        simu = simulation_activation (thibault,[sphere,sphere2,sphere3])
        
        simu.simule_activation()   
    ...
    print('')
    print('Cible souhaitée : ', getelem('spe.csv',3,21))
    print('')        
            
    plt.figure(figsize=(8,6),dpi=120)
    plt.axis([7,26.5,0,1.1])
    plt.grid()
