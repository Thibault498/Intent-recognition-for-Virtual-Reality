...
if __name__=="__main__":
    ...
    for i in range (1,1488):
        ...
        simu = simulation (thibault,[sphere,sphere2,sphere3])
        print('')
        print('Cible souhaitée : ', getelem('01.csv',i,21))
        print('')
        list_prob=simu.simule()   
        cib0.append(list_prob[0])
        cib1.append(list_prob[1])
        cib2.append(list_prob[2])
        list_prob=0    
            
            
            
    plt.figure(figsize=(8,6),dpi=120)
    plt.axis([4,26.5,0,0.8])
    plt.grid()
